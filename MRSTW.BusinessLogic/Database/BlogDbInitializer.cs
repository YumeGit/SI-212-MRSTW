...
namespace MRSTW.BusinessLogic.Database
{
	public class BlogDbInitializer : DropCreateDatabaseAlways<BlogDbContext>
	{
		...
		{
            var userDanila = context.Users.Add(new User()
            {
            ...
            var userMax = context.Users.Add(new User()
            {
			...
			var userDima = context.Users.Add(new User() 
            { 
            ...
            var userKatia = context.Users.Add(new User()
            {
            ...
            var userOleg = context.Users.Add(new User()
            {
                Name = "Oleg Somov",
                PasswordHash = AuthHelper.GeneratePasswordHash("123"),
            ...
            var userUmklai = context.Users.Add(new User()
            {
                Name = "Umklaidet",
                PasswordHash = AuthHelper.GeneratePasswordHash("123"),
                                        ...
                                        Comments = new List<Comment>()
                                        {
                                            new Comment()
                                            {
                                                ...
                                                Reactions = new List<Reaction>()
                                                {
                                                    ...
                                                    {
                                                        Author = userMax,
                                                        Emoji = "<img src=\"/Content/Images/Clyde.png\">"
                                                    }
                                                }
                                            }
                                        }

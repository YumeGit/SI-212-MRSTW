...
namespace MRSTW.BusinessLogic.Database
{
	public class BlogDbInitializer : DropCreateDatabaseAlways<BlogDbContext>
	{
		protected override void Seed(BlogDbContext context)
		{
            ...
            //---------------------------------------------------//
            var catAnime    = context.Categories.Add(new Category { 
                Name = "anime",	
                Title = "Аниме",
                Posts = new List<Post>()
                {
                                ...
                                Comments = new List<Comment>()
                                {
                                    new Comment()
                                    {
                                        ...
                                        Comments = new List<Comment>()
                                        {
                                            new Comment()
                                            {
                                                Message = "Во первых у нас есть комментарии",
                                                Author = userDima,
                                                Comments = new List<Comment>()
                                                {
                                                    new Comment()
                                                    {
                                                        Message = "И на них можно оставлять реакции",
                                                        Author = userKatia,
            ...
            var catNature = context.Categories.Add(new Category { 
                Name = "nature", 
                Title = "Природа",
                Posts = new List<Post>()
                {
            ...
            var catGames = context.Categories.Add(new Category {
                Name = "games", 
                Title = "Игры" ,
                Posts = new List<Post>()
                { 
            ...
            var catIt = context.Categories.Add(new Category
            {
                Name = "it",
                Title = "IT",
                Posts = new List<Post>()
            ...
            var catCulture = context.Categories.Add(new Category { 
                Name = "culture", 
                Title = "Культура",
                Posts = new List<Post>()
                {

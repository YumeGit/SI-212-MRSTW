...
namespace MRSTW.BusinessLogic.Database
{
	public class BlogDbInitializer : DropCreateDatabaseAlways<BlogDbContext>
	{
		protected override void Seed(BlogDbContext context)
		{
            ...
            //---------------------------------------------------//
            context.Categories.Add(new Category { Name = "nature",	Title = "Природа" });
            context.Categories.Add(new Category { Name = "games",	Title = "Игры" });
            context.Categories.Add(new Category { Name = "culture",	Title = "Культура" });
            context.Categories.Add(new Category { Name = "it",		Title = "IT" });
            context.Categories.Add(new Category { Name = "anime",	Title = "Аниме" });
            //---------------------------------------------------//
